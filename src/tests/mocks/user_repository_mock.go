...
import (
	...
	rest_err "github.com/Alan-Gomes1/go-api/src/configuration/rest_err"
	model "github.com/Alan-Gomes1/go-api/src/model"
...
func (m *MockUserRepository) CreateUser(userDomain model.UserDomainInterface) (model.UserDomainInterface, *rest_err.Errors) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", userDomain)
	ret0, _ := ret[0].(model.UserDomainInterface)
	ret1, _ := ret[1].(*rest_err.Errors)
	return ret0, ret1
}
...
func (m *MockUserRepository) DeleteUser(userId string) *rest_err.Errors {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteUser", userId)
	ret0, _ := ret[0].(*rest_err.Errors)
	return ret0
}
...
func (m *MockUserRepository) FindUserByEmail(email string) (model.UserDomainInterface, *rest_err.Errors) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByEmailAndPassword(email, password string) (model.UserDomainInterface, *rest_err.Errors) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByID(id string) (model.UserDomainInterface, *rest_err.Errors) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) UpdateUser(userId string, userDomain model.UserDomainInterface) *rest_err.Errors {
	m.ctrl.T.Helper()
